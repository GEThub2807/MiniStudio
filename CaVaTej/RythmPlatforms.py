...
class Jeu:
    def __init__(self):
        ...
        self.player = Player(self.player_x, self.player_y,50,50, self.image, self.vitesse_x,
                             self.vitesse_y)
        self.player.image = pygame.transform.scale(self.image,(self.player.width,self.player.height))
